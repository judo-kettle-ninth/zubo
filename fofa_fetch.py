...
# 配置区
FOFA_URLS = {
    "https://fofa.info/result?qbase64=InVkcHh5IiAmJiBjb3VudHJ5PSJDTiIgJiYgcmVnaW9uPSJHdWFuZ2RvbmciICYmIGFzbj0iOTgwOCI%3D": "ip.txt",
}
HEADERS = {
...
CHANNEL_CATEGORIES = {
    ...
    "体育": [
        "五星体育","辽宁体育","深圳体育健康","爱体育","杭州青少体育","百事通体育直播1","百事通体育直播2","汕头文旅体育","体育竞技","陕西体育","BesTV体育",
        "百事通超级体育","山东体育","天津体育","江苏体育休闲","北京体育休闲","山东体育频道"
    ],
}
